...
public class CkImap {
  ...
  public boolean FetchAttachmentBd(CkEmail email, int attachmentIndex, CkBinData binData) {
    return chilkatJNI.CkImap_FetchAttachmentBd(swigCPtr, this, CkEmail.getCPtr(email), email, attachmentIndex, CkBinData.getCPtr(binData), binData);
  }

  public CkTask FetchAttachmentBdAsync(CkEmail email, int attachmentIndex, CkBinData binData) {
    long cPtr = chilkatJNI.CkImap_FetchAttachmentBdAsync(swigCPtr, this, CkEmail.getCPtr(email), email, attachmentIndex, CkBinData.getCPtr(binData), binData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean LoginSecure(CkSecureString loginName, CkSecureString password) {
    return chilkatJNI.CkImap_LoginSecure(swigCPtr, this, CkSecureString.getCPtr(loginName), loginName, CkSecureString.getCPtr(password), password);
  }

  public CkTask LoginSecureAsync(CkSecureString loginName, CkSecureString password) {
    long cPtr = chilkatJNI.CkImap_LoginSecureAsync(swigCPtr, this, CkSecureString.getCPtr(loginName), loginName, CkSecureString.getCPtr(password), password);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean MoveMessages(CkMessageSet messageSet, String destFolder) {
    return chilkatJNI.CkImap_MoveMessages(swigCPtr, this, CkMessageSet.getCPtr(messageSet), messageSet, destFolder);
  }

  public CkTask MoveMessagesAsync(CkMessageSet messageSet, String destFolder) {
    long cPtr = chilkatJNI.CkImap_MoveMessagesAsync(swigCPtr, this, CkMessageSet.getCPtr(messageSet), messageSet, destFolder);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
